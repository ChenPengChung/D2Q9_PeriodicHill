...
// 外力項
//=============================================================================
extern double  Heff ;                       // 山丘流場截面平均高度
extern double  AverageVolumeVelocity_t ;    // 時間t的體流流率面積加權平均
extern double  Ubar_filter ;                // 指數濾波後的全場平均速度
extern double  force[2];                    // 外力項 [0]=Fy, [1]=Fz
extern double  ubulk[NY6] ;                 // 截面平均速度 (U_bulk)
//=============================================================================
// 網格座標
//=============================================================================
