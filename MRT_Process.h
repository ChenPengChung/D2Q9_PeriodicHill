...
#define collision	\
    ...
    F1_in  = F1_in - M_I[1][0]*s0*(m0-meq0)- M_I[1][1]*s1*(m1-meq1)- M_I[1][2]*s2*(m2-meq2)- M_I[1][3]*s3*(m3-meq3)- M_I[1][4]*s4*(m4-meq4)- M_I[1][5]*s5*(m5-meq5)- M_I[1][6]*s6*(m6-meq6)- M_I[1][7]*s7*(m7-meq7)- M_I[1][8]*s8*(m8-meq8) + 3 * dt * force[0] * (1/9.0);\
    ...
    F3_in  = F3_in - M_I[3][0]*s0*(m0-meq0)- M_I[3][1]*s1*(m1-meq1)- M_I[3][2]*s2*(m2-meq2)- M_I[3][3]*s3*(m3-meq3)- M_I[3][4]*s4*(m4-meq4)- M_I[3][5]*s5*(m5-meq5)- M_I[3][6]*s6*(m6-meq6)- M_I[3][7]*s7*(m7-meq7)- M_I[3][8]*s8*(m8-meq8) + 3 * dt * force[0] * (-1/9.0);\
    ...
    F5_in  = F5_in - M_I[5][0]*s0*(m0-meq0)- M_I[5][1]*s1*(m1-meq1)- M_I[5][2]*s2*(m2-meq2)- M_I[5][3]*s3*(m3-meq3)- M_I[5][4]*s4*(m4-meq4)- M_I[5][5]*s5*(m5-meq5)- M_I[5][6]*s6*(m6-meq6)- M_I[5][7]*s7*(m7-meq7)- M_I[5][8]*s8*(m8-meq8) + 3 * dt * force[0] * (1/36.0);\
    F6_in  = F6_in - M_I[6][0]*s0*(m0-meq0)- M_I[6][1]*s1*(m1-meq1)- M_I[6][2]*s2*(m2-meq2)- M_I[6][3]*s3*(m3-meq3)- M_I[6][4]*s4*(m4-meq4)- M_I[6][5]*s5*(m5-meq5)- M_I[6][6]*s6*(m6-meq6)- M_I[6][7]*s7*(m7-meq7)- M_I[6][8]*s8*(m8-meq8) + 3 * dt * force[0] * (-1/36.0);\
    F7_in  = F7_in - M_I[7][0]*s0*(m0-meq0)- M_I[7][1]*s1*(m1-meq1)- M_I[7][2]*s2*(m2-meq2)- M_I[7][3]*s3*(m3-meq3)- M_I[7][4]*s4*(m4-meq4)- M_I[7][5]*s5*(m5-meq5)- M_I[7][6]*s6*(m6-meq6)- M_I[7][7]*s7*(m7-meq7)- M_I[7][8]*s8*(m8-meq8) + 3 * dt * force[0] * (-1/36.0);\
    F8_in  = F8_in - M_I[8][0]*s0*(m0-meq0)- M_I[8][1]*s1*(m1-meq1)- M_I[8][2]*s2*(m2-meq2)- M_I[8][3]*s3*(m3-meq3)- M_I[8][4]*s4*(m4-meq4)- M_I[8][5]*s5*(m5-meq5)- M_I[8][6]*s6*(m6-meq6)- M_I[8][7]*s7*(m7-meq7)- M_I[8][8]*s8*(m8-meq8) + 3 * dt * force[0] * (1/36.0); 
#endif